...
At this point, we have finished installing Wazuh. All that's left is to explore its features, on which there are many. Expanding the hamburger menu, we get the following pages:
